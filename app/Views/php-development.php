               ...
               <table class="table table-borderless job-summery-table" >
                  <tbody>
                     ...
                     <tr>
                        ...
                        <td width="80%">PHP Developer/Web Developer/PHP/HTML/WordPress/MySQL.</td>
                     </tr>
                     <tr>
                     ...
                     <tr>
                        ...
                        <td width="80%"><i class="fa fa-circle-o"></i>&nbsp; Candidate should have more than 1 year of experience in PHP development.
                           <br/><i class="fa fa-circle-o"></i>&nbsp; Candidate should have good knowledge of Core PHP.<br/><i class="fa fa-circle-o"></i>&nbsp; CodeIgniter, Drupal, Zend or Wordpress would be a plus point.</td>
                     </tr>
                     <tr>
                        <th scope="row" width="20%">Skills Needed</th>
                        <td width="80%">Core PHP, Codeigniter, Drupal, or Wordpress, HTML, CSS, jQuery, Bootstrap, MVC, Payment Gateways, e-Commerce, Social media integrations etc.</td>
                     </tr>
                  </tbody>
               </table>
            </ul>
