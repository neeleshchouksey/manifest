...
<link rel="shortcut icon" type="image/ico" href="<?php echo base_url();?>/assets/images/common-img/favicon.ico"/>
...
<!-- CSS Files -->
<link rel="stylesheet" type="text/css" href="<?php echo base_url();?>/assets/css/box-animation.css" />
<link rel="stylesheet" type="text/css" href="<?php echo base_url();?>/assets/css/component.css" />
<link rel="stylesheet" href="<?php echo base_url();?>/assets/css/bootstrap.css"/>
<link rel="stylesheet" href="<?php echo base_url();?>/assets/css/bootstrap-responsive.css"/>
<link rel="stylesheet" href="<?php echo base_url();?>/assets/css/manifest.css"/>
<link rel="stylesheet" type="text/css" href="<?php echo base_url();?>/assets/css/normalize.css"/>
<link rel="stylesheet" type="text/css" href="<?php echo base_url();?>/assets/css/product-detail.css" />
<link rel="stylesheet" href="<?php echo base_url();?>/assets/icon-font/css/font-awesome.css"/>
<link rel="stylesheet" href="<?php echo base_url();?>/assets/css/responsive.css"/>
<link rel="stylesheet" href="<?php echo base_url();?>/assets/css/style_common.css"/>
<link rel="stylesheet" href="<?php echo base_url();?>/assets/css/style10.css"/>
<link rel="stylesheet" href="<?php echo base_url();?>/assets/css/simpleslider.css"/>
<link rel="stylesheet" href="<?php echo base_url();?>/assets/css/slider.css"/>
<link rel="stylesheet" href="<?php echo base_url();?>/assets/css/flexslider.css">
<link rel="stylesheet" href="<?php echo base_url();?>/assets/css/submenu.css"/>
<link rel="stylesheet" href="<?php echo base_url();?>/assets/css/custom.css"/>
<link rel="stylesheet" href="<?php echo base_url();?>/assets/css/sky-tabs.css"/>
...
<link rel="stylesheet" href="<?php echo base_url();?>/assets/css/manifest_new.css" type="text/css"/>
<link rel="stylesheet" type="text/css" href="<?php echo base_url();?>/assets/css/component_portfolio.css" />
<!-- End CSS Files -->

<script src="<?php echo base_url();?>/assets/js/modernizr.custom_portfolio.js"></script>
...
<link rel="stylesheet" href="<?php echo base_url();?>/assets/plugin/portfolio/css/layout.css">
<!-- New Portfolio -->
<script type="text/javascript" src="http://ajax.googleapis.com/ajax/libs/jquery/1.9.1/jquery.min.js"></script>
<script type="text/javascript" src="<?php echo base_url();?>/assets/plugin/portfolio/js/jquery.mixitup.min.js"></script>
<script type="text/javascript">
	$(function () {
		var filterList = {
			init: function () {
  ...
  <div class="inner navigation fixed-header">
    <div class="p-logo">
        <a class="scroll" id="themify-logo img" href="<?php echo site_url();?>">
          <img src="<?php echo base_url();?>/assets/images/common-img/logo.png" class="logo log_foooter" alt="Manifest Infotech" title="Manifest Infotech">
        </a>
    </div>
