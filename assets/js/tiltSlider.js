...
;( function( window ) {
	...
	function TiltSlider( el, options ) {
		...
		this.animEffectsOut = ['slideUpOut','slideDownOut','slideRightOut'];
		this.animEffectsIn = ['slideUpIn','slideDownIn','slideRightIn'];
		// the items
	...
	TiltSlider.prototype._showItem = function( pos ) {
		...
		var cntAnims = 0,
			...
			onEndAnimationCurrentItem = function() {
				++animEndCurrentCnt;
				var endFn = function() {
					classie.removeClass( currentItem, 'hide-slider' );
		...
		classie.addClass( currentItem, 'hide-slider' );
